...
public class RotatedPoints extends JFrame implements GLEventListener{
    ...
    public RotatedPoints(){
        setTitle("Two points rotated");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public void display(GLAutoDrawable drawable){
        ...
        Matrix3D mMat = new Matrix3D(); // this is the identity matrix
        double rotationDeg = (double) -45;
        mMat.translate(0.5, 0, 0);
        mMat.rotateZ(rotationDeg);
        
        // now make it available to the "mv_matrix"
        gl.glUniformMatrix4fv(mv_location, 1, false, mMat.getFloatValues(),0);
