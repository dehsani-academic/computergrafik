...
public class CubeDifferentColorsAufgabe3 extends JFrame implements GLEventListener{
    ...
    public CubeDifferentColorsAufgabe3(){
        setTitle("HW 4: AG 3");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public void display(GLAutoDrawable drawable){
        ...
        mvStack.rotate(rotateDeg, 1, 1, 0);
    ...
    public static void main(String[ ] args){
        new CubeDifferentColorsAufgabe3();
    }
