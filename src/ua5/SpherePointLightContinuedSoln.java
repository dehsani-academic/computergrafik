...
public class SpherePointLightContinuedSoln extends JFrame implements GLEventListener
{   private GLCanvas myCanvas;
    ...
    public SpherePointLightContinuedSoln()
    {   setTitle("basic sphere with point light source");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public void installLights(Matrix3D viewMatrix) {
        ...
        Point3D lightLoc = new Point3D(3.0f, 3.0f, 3.0f); 
        ...
        pl.setLinearAtt(0.01f); // k_l 
        pl.setQuadraticAtt(0.01f); // k_q 
    ...
    public static void main(String[] args) {
        new SpherePointLightContinuedSoln(); 
    }
    ...
    private int createShaderProgram(){    
        ...
        String vshaderSource[] = util.readShaderSource("vert_14a.shader");
        String fshaderSource[] = util.readShaderSource("frag_14a.shader");
