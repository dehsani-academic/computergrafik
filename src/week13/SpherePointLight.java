...
public class SpherePointLight extends JFrame implements GLEventListener
{   private GLCanvas myCanvas;
    ...
    public void installLights(Matrix3D viewMatrix) {
        ...
        Point3D lightLoc = new Point3D(10.0f, 10.0f, 10.0f); 
        ...
        pl.setLinearAtt(0.1f); // k_l 
        pl.setQuadraticAtt(0.1f); // k_q 
        ...
        gl.glProgramUniform4fv(rendering_program, ambLoc, 1, pl.getAmbient(), 0);
        gl.glProgramUniform4fv(rendering_program, diffLoc, 1, pl.getDiffuse(), 0);
        gl.glProgramUniform4fv(rendering_program, specLoc, 1, pl.getSpecular(), 0);
        gl.glProgramUniform3fv(rendering_program, posLoc, 1, viewspaceLightPos, 0);
        gl.glProgramUniform4fv(rendering_program, materialAmbLoc, 1, sphereMaterial.getAmbient(), 0);
        gl.glProgramUniform4fv(rendering_program, materialDiffLoc, 1, sphereMaterial.getDiffuse(), 0);
        gl.glProgramUniform4fv(rendering_program, materialSpecLoc, 1, sphereMaterial.getSpecular(), 0);
        gl.glProgramUniform1f(rendering_program, materialShineLoc, sphereMaterial.getShininess());
