...
public class SphereSpotlight extends JFrame implements GLEventListener
{   private GLCanvas myCanvas;
    ...
    public void installLights(Matrix3D viewMatrix) {
        ...
        Point3D lightLoc = new Point3D(5.0f, 5.0f, 5.0f); 
        ...
        sl.setDirection(directionVector); 
        sl.setCutoffAngle(45.0f); // how wide the spotlight shines 
        ...
        gl.glProgramUniform4fv(rendering_program, ambLoc, 1, sl.getAmbient(), 0);
        gl.glProgramUniform4fv(rendering_program, diffLoc, 1, sl.getDiffuse(), 0);
        gl.glProgramUniform4fv(rendering_program, specLoc, 1, sl.getSpecular(), 0);
