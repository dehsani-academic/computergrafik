...
public class SphereDirectionalLightContinued extends JFrame implements GLEventListener
{   private GLCanvas myCanvas;
    ...
    public SphereDirectionalLightContinued()
    ...
    public void installLights(Matrix3D viewMatrix) {
        ...
        Vector3D directionVector = new Vector3D(1, 1, -1);
    ...
    {   GL4 gl = (GL4) GLContext.getCurrentGL();
        ...
        //int n_loc = gl.glGetUniformLocation(rendering_program, "norm_matrix");
    ...
    public static void main(String[] args) {
        new SphereDirectionalLightContinued(); 
    }
