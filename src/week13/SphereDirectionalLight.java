...
public class SphereDirectionalLight extends JFrame implements GLEventListener
{   private GLCanvas myCanvas;
    ...
    public void installLights(Matrix3D viewMatrix) {
        ...
        gl.glProgramUniform4fv(rendering_program, ambLoc, 1, dl.getAmbient(), 0);
        gl.glProgramUniform4fv(rendering_program, diffLoc, 1, dl.getDiffuse(), 0);
        gl.glProgramUniform4fv(rendering_program, specLoc, 1, dl.getSpecular(), 0);
