...
public class TwoFloorsFromOne extends JFrame implements GLEventListener{
    ...
    {   GL4 gl = (GL4) GLContext.getCurrentGL();
        ...
        //              Types objectType)
        initObject(0, verts, floor_colors, square_indices, Types.TRIANGLES);
        
        // init ceiling
        initObject(1, verts, ceiling_colors, square_indices, Types.TRIANGLES);
