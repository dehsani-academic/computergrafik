...
public class TrianglePerspective extends JFrame implements GLEventListener{
    ...
    public TrianglePerspective(){
        setTitle(" Roatating Triangle");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public void display(GLAutoDrawable drawable){
        ...
        // after drawing erase the stack (here doesn't matter, but it necessary when 
        // a series of screenshots are created with different matrices (as in animation!)
