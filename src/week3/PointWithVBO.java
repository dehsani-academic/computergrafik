...
public class PointWithVBO extends JFrame implements GLEventListener{
    ...
    public PointWithVBO(){
        setTitle("A Single PointWithVBO");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public void display(GLAutoDrawable drawable){
        ...
        // use the vbo to feed position into shaders
    ...
    public int createShaderProgram() {
        ...
        String vshaderSource[] = util.readShaderSource("vert_3a.shader");
        String fshaderSource[] = util.readShaderSource("frag_3a.shader");
