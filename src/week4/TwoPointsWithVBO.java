...
public class TwoPointsWithVBO extends JFrame implements GLEventListener{
    ...
    public TwoPointsWithVBO(){
        setTitle("Two points drawn");
        setSize(600, 400);
        setLocation(200, 200);
    ...
    public int createShaderProgram() {
        ...
        String vshaderSource[] = util.readShaderSource("vert_4a.shader");
        String fshaderSource[] = util.readShaderSource("frag_4a.shader");
