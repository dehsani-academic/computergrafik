...
public class SphereShadowDifferentMaterials extends JFrame implements GLEventListener
{   
    ...
    public SphereShadowDifferentMaterials()
    ...
    public static void main(String[] args) {
        new SphereShadowDifferentMaterials(); 
    }
